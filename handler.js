...
this.sendButton(id, text, groupMetadata.subject, apii.data, [[(action == 'add' ? '💫𝘽𝙄𝙀𝙉𝙑𝙀𝙉𝙄𝘿𝙊/𝘼💫' :'ADIOS FAN DE BTS🏳️‍🌈'), (action == 'add' ? '#welcomegc' : '#byegc')], ['⦙☰ 𝗠𝗘𝗡𝗨', `#menu`]], ftroli, {mentions: this.parseMention(text)})
